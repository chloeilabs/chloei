...
This section validates the Cursor Cloud Agent control plane. It can load a GitHub repository and branch automatically, start a cloud coding run, track run status and events, and surface the resulting pull request link when the run completes.
