...
const DEFAULT_CLOUD_AGENT_MAX_CONCURRENT_PER_USER = 3
...
export const CLOUD_AGENT_MAX_CONCURRENT_PER_USER = parsePositiveIntFromEnv(
  process.env.CLOUD_AGENT_MAX_CONCURRENT_PER_USER,
  DEFAULT_CLOUD_AGENT_MAX_CONCURRENT_PER_USER
)
